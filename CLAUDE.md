...
- **Pytest**: Testing harness (341 unit + 113 MCP unit + 32 E2E = 486 pytest tests)
...
# Development
pytest src/python/tests/        # Run Python unit tests (341 unit + 113 MCP)
...
```bash
pytest src/python/tests/        # 341 unit tests passing
...
- `src/python/` - Python backend
  ...
  - `tests/` - Test suite (341 unit + 113 MCP unit + 32 E2E pytest tests)
