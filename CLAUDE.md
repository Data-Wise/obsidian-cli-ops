...
- **Pytest**: Testing harness (350+ unit + 113 MCP unit + 32 E2E pytest)
...
# Development
pytest src/python/tests/        # Run Python unit tests (350+ unit + 113 MCP)
...
```bash
pytest src/python/tests/        # 350+ unit tests passing
...
- `src/python/` - Python backend
  ...
  - `tests/` - Test suite (350+ unit + 113 MCP unit + 32 E2E pytest tests)
