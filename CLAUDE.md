...
- **Pytest**: Testing harness (450+ unit + 113 MCP unit + 32 E2E pytest)
...
# Development
pytest src/python/tests/        # Run Python unit tests (450+ unit + 113 MCP)
...
```bash
pytest src/python/tests/        # 450+ unit tests passing
...
- `src/python/` - Python backend
  ...
  - `tests/` - Test suite (450+ unit + 113 MCP unit + 32 E2E pytest tests)
