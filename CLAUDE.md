...
- **Pytest**: Testing harness (410+ unit + 113 MCP unit + 32 E2E pytest)
...
# Development
pytest src/python/tests/        # Run Python unit tests (410+ unit + 113 MCP)
...
```bash
pytest src/python/tests/        # 410+ unit tests passing
...
- `src/python/` - Python backend
  ...
  - `tests/` - Test suite (410+ unit + 113 MCP unit + 32 E2E pytest tests)
