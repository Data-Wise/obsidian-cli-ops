...
- refactor_vault: AI-powered vault reorganization (see features_refactor.py)
"""
...
# Backward-compatible re-exports from features_refactor.py (extracted in v3.2.0)
from .features_refactor import RefactorSuggestion, RefactorPlan, refactor_vault
