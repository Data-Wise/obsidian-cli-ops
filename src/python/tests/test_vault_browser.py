    ...
    db.list_vaults.return_value = [
        {
            ...
            'note_count': 150,
            'link_count': 320,
            'last_scanned': '2025-12-15T10:30:00'
        },
        {
            'id': 2,
            'name': 'Personal Vault',
            ...
            'note_count': 85,
            'link_count': 140,
            'last_scanned': '2025-12-14T15:20:00'
        },
        {
            'id': 3,
...
@pytest.fixture
def vault_browser(mock_db, mock_app):
    """Create a VaultBrowserScreen instance with mocks."""
    with patch('tui.screens.vaults.DatabaseManager', return_value=mock_db):
...
class TestVaultBrowserScreen:
    ...
    def test_vault_browser_initialization(self, mock_db):
    ...
    def test_refresh_vaults_loads_data(self, vault_browser, mock_db):
    ...
    def test_refresh_vaults_empty_database(self, vault_browser, mock_db):
    ...
    def test_refresh_vaults_formats_timestamps(self, vault_browser, mock_db):
    ...
    def test_refresh_vaults_handles_unnamed_vault(self, vault_browser, mock_db):
    ...
    def test_refresh_vaults_shortens_long_paths(self, vault_browser, mock_db):
    ...
    def test_show_vault_details_displays_statistics(self, vault_browser, mock_db):
        """Test that vault details shows statistics."""
        vault_browser.selected_vault = {
            'id': 1,
            'name': 'Work Vault',
            'path': '/home/user/Documents/Work',
            'note_count': 150,
        ...
        mock_db.get_orphaned_notes.assert_called_once_with(1)
        mock_db.get_hub_notes.assert_called_once()
        mock_db.get_broken_links.assert_called_once_with(1)
        mock_db.get_tag_stats.assert_called_once_with(1)
    ...
    def test_on_data_table_row_selected(self, vault_browser, mock_db):
        """Test row selection handler."""
        # Set up vault data
        vault_browser.vaults = mock_db.list_vaults()
    ...
    def test_action_refresh(self, vault_browser, mock_db):
        ...
        mock_db.list_vaults.assert_called()
...
class TestVaultBrowserIntegration:
    ...
    def test_full_navigation_flow(self, vault_browser, mock_db, mock_app):
        ...
        # 1. Refresh vaults
        vault_browser.refresh_vaults()
        assert mock_db.list_vaults.called
        ...
        # 3. View details
        vault_browser.show_vault_details()
        assert mock_db.get_orphaned_notes.called
    ...
    def test_full_graph_navigation_flow(self, vault_browser, mock_db, mock_app):
    ...
    def test_error_handling_with_database_issues(self, mock_app):
        ...
        mock_db = Mock()
        mock_db.list_vaults.side_effect = Exception("Database error")
