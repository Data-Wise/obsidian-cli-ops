...
The MCP server (`src/python/mcp_server.py`) exposes 40 tools and 4 resources over stdio to Claude Desktop, Claude Code, and Cowork.
...
- [Claude Integration](../claude-integration.md) — MCP setup guide with all 40 tools
