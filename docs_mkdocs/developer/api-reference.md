...
The MCP server (`src/python/mcp_server.py`) exposes 41 tools and 4 resources over stdio to Claude Desktop, Claude Code, and Cowork.
...
- [Claude Integration](../claude-integration.md) — MCP setup guide with all 41 tools
