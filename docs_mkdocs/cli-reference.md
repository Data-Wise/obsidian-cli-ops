...
> **TL;DR** (30 seconds)
> - **What:** Full reference for all 46 `obs` commands (17 top-level groups, incl. the config & research families absorbed from nexus-cli in v4.0.0) + 41 MCP tools for Claude
...
`obs` exposes **41 MCP tools** via `src/python/mcp_server.py` for use in Claude Desktop,
...
See [Claude Integration](claude-integration.md) for full setup instructions and all 41 tools.
