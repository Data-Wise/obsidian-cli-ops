...
> **TL;DR** (30 seconds)
> - **What:** Full reference for all 35 `obs` commands (19 core + 16 from the nexus-cli absorption, shipped in v4.0.0) + 38 MCP tools for Claude
...
`obs` exposes **38 MCP tools** via `src/python/mcp_server.py` for use in Claude Desktop,
...
See [Claude Integration](claude-integration.md) for full setup instructions and all 38 tools.
