...
!!! tip "Claude Integration (v4.0.0)"
    38 MCP tools connect `obs` to Claude Desktop, Claude Code, and Cowork. Ask Claude to search, analyze, create, and edit your vault notes in plain English. [Setup takes 5 minutes →](claude-integration.md)
...
- [Claude Integration](claude-integration.md) -- MCP server setup (38 tools)
