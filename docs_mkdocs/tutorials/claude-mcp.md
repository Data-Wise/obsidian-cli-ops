...
MCP (Model Context Protocol) lets Claude Desktop call tools in external programs. `obs` ships an MCP server (`mcp_server.py`) that exposes **20 tools** covering your full vault workflow:
...
| All 20 MCP tools | [CLI Reference — MCP section](../cli-reference.md#claude-mcp-integration) |
